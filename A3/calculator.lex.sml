functor CalculatorLexFun(structure Tokens: Calculator_TOKENS)=
   struct
...
\\017\003\003\003\003\003\003\003\016\015\014\013\003\012\011\010\
\\008\008\008\008\008\008\008\008\008\008\003\007\003\003\003\003\
...
let fun continue() = lex() in
 ...
 in (yybufpos := i; case yyk of 
  ...
  1 => (pos := (!pos) + 1; lex())
| 11 => (Tokens.MUL(!pos,!pos))
| 13 => (Tokens.SEMI(!pos,!pos))
| 16 => let val yytext=yymktext() in if yytext="showfraction"
...
| 18 => (Tokens.LPAR(!pos,!pos))
| 20 => (Tokens.RPAR(!pos,!pos))
| 22 => (Tokens.SUB(!pos,!pos))
| 24 => (Tokens.NEG(!pos,!pos))
| 26 => (Tokens.DIV(!pos,!pos))
| 28 => (Tokens.DOT(!pos,!pos))
| 30 => let val yytext=yymktext() in error ("ignoring bad character "^yytext,!pos,!pos);
             lex() end
| 4 => (lex())
| 7 => let val yytext=yymktext() in Tokens.INT(BigInt.fromString yytext,!pos,!pos) end
